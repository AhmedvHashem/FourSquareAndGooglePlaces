...
public interface ApiServices {
    ...
    Observable<GoogleNearbyResponse> googleNearby(
    ...
    @GET("details/json")
    Observable<GooglePlaceDetailsResponse> googlePlaceDetails(@Url String baseUrl,
                                                              @Query("key") String apiKey,
                                                              @Query("placeid") String placeId);

    //section=food
    @GET("venues/explore")
    Observable<FoursquareNearbyResponse> fouresquareNearby(
    ...
    @GET("venues/{placeid}")
    Observable<FoursquarePlaceDetailsResponse> fouresquarePlaceDetails(@Url String baseUrl,
